...
export interface ApiEnriqueFooterEnriqueFooter extends Struct.SingleTypeSchema {
  collectionName: 'enrique_footers';
  info: {
    description: '';
    displayName: 'Enrique Footer';
    pluralName: 'enrique-footers';
    singularName: 'enrique-footer';
  };
  options: {
  ...
  attributes: {
    allRights: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    Column1Links: Schema.Attribute.DynamicZone<
      ['footer.footer-link', 'footer.spacer']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    Column1title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    Column2Links: Schema.Attribute.DynamicZone<
      ['footer.footer-link', 'footer.spacer']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    Column2Title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    copyright: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'copyright'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::enrique-footer.enrique-footer'
    >;
    publishedAt: Schema.Attribute.DateTime;
    siteMade: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }> &
      Schema.Attribute.DefaultTo<'Site made with:'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiEnriqueHeaderEnriqueHeader extends Struct.SingleTypeSchema {
  collectionName: 'enrique_headers';
  info: {
    description: '';
    displayName: 'Enrique Header';
    pluralName: 'enrique-headers';
    singularName: 'enrique-header';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    HeaderButtons: Schema.Attribute.DynamicZone<['button.buttons']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    HeaderLinks: Schema.Attribute.DynamicZone<['header.link-item']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::enrique-header.enrique-header'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiEnriquePageEnriquePage extends Struct.CollectionTypeSchema {
  collectionName: 'enrique_pages';
  info: {
    description: '';
